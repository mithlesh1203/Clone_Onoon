...
function ProductDesription() {
  const id = useParams();
  const [productData, setProductData] = useState([]);
  console.log("🚀 ~ file: ProductDesription.js:8 ~ ProductDesription ~ productData", productData)
...
// console.log(location.state)
  ...
  const getAPIData = () =>{
   axios.get(`https://dummyjson.com/products`)
    ...
    .catch((error) =>     console.log("🚀 ~ file: ProductDesription.js:25 ~ getAPIData ~ error", error));
  } 
  return (
    <div>
      <Navbar />
